...
import { LanguageSelect } from "@/presentation/components/shared/ui/dropdowns/Language";
import ThemeSelect from "@/presentation/components/shared/ui/dropdowns/Theme";
            ...
            <div className="h-full flex flex-row">
              <div className="flex flex-col justify-between h-full w-full">
                ...
                <div>
                  ...
                  <UserSession toggleOptions={handleClose} />
                </div>
              </div>
            </div>
          </motion.div>
