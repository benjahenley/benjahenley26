...
import { FollowButtonHome } from "@/presentation/components/shared/ui/FollowButton";
...
import Leftbar from "@/presentation/components/sections/leftbar";
import RightBar from "@/presentation/components/sections/rightbar";
            ...
            <div className=" mx-auto ">
              ...
              <div className="px-2 md:px-3 relative">
                <div className="flex flex-row overflow-visible justify-between items-end space-y-2 pt-5 md:pt-20 h-[40px]">
                  ...
                  <FollowButtonHome
                    locale={locale}
                    className="min-w-[120px] absolute top-2 right-2 bg-[#E85A4F] text-white rounded-full flex items-center justify-center hover:border-3 hover:border-black"
                  />
                </div>
