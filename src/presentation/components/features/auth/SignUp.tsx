...
import { SectionText, SectionTitle } from "../../shared/ui/Texts";
...
const SignUp = () => {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.3 }}>
      <div className="relative flex flex-col space-y-1.5 p-6 pb-2 bg-gradient-to-r from-purple-500 to-indigo-600 dark:from-emerald-500/50 dark:to-teal-600/50">
        <motion.h2
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        {/* <SectionTitle className="font-semibold tracking-tight text-2xl text-center mb-1 text-white">
        </SectionTitle>
        <SectionText className="text-sm text-gray-300 text-center dark:text-gray-300">
        </SectionText> */}
      </div>
