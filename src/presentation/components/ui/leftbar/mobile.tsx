...
import ThemeSelect from "../selects/Theme";
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="max-h-[100vh] fixed pr-0 md:hidden z-[9999999] top-0 left-0 right-20 bottom-0 max-w-[256px] bg-gray-100 dark:bg-slate-700">
              ...
              <div className=" px-4 py-1 border-b xl:border-none lg:px-4 border-gray-300 dark:border-slate-600 lg:flex-col xl:flex-row flex items-center gap-2 justify-between lg:py-4 lg:pb-8 xl:py-2">
                <span className="dark:text-white text-5xl xl:text-7xl cursor-pointer py-2 flex flex-row justify-between items-center w-full">
                  <div className="text-gray-800 dark:text-white flex items-center justify-center ">
                    <a href="/" className="text-5xl md:text-6xl cursor-pointer">
                      BH
                    </a>
                  </div>
                  ...
                  <RxCrossCircled
                    ...
                    onClick={handleClose}></RxCrossCircled>
                </span>
              </div>
                ...
                <div className="py-3 flex flex-col w-full h-full mb-4">
                  {OPTIONS.map(({ logo, text, href }, key) => (
                    <Link href={href} key={key}>
                      <div className="py-4 dark:text-white hover:bg-gray-200 dark:hover:bg-slate-700 cursor-pointer flex flex-row justify-start lg:justify-center xl:justify-start items-center gap-4 px-4">
