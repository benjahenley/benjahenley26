      ...
      <div className="grid place-items-center gap-2.5">
        <div className="flex space-x-2.5">
          <a
            ...
            <FaInstagramSquare className="text-gray-800 dark:text-gray-400 hover:text-gray-600 hover:dark:text-gray-300 hover:scale-105 text-3xl" />
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer">
            <FaGithubSquare className="text-gray-800 dark:text-gray-400 hover:text-gray-600 hover:dark:text-gray-300 hover:scale-105 text-3xl" />
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer">
            <FaLinkedin className="text-gray-800 dark:text-gray-400 hover:text-gray-600 hover:dark:text-gray-300 hover:scale-105 text-3xl" />
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer">
            <FaWhatsappSquare className="text-gray-800 dark:text-gray-400 hover:text-gray-600 hover:dark:text-gray-200 hover:scale-105 text-3xl" />
          </a>
        </div>
