...
import Project from "@/presentation/components/features/projects/Project";
import { useModal } from "@/presentation/components/shared/modals/context";
import ProjectCommentSection from "@/presentation/components/features/projects/ProjectCommentSection";
import PROJECT_DATA from "@/infraestructure/data/Projects";
      ...
      <AnimatePresence mode="wait">
        {selectedApiProject ? (
          ...
          <motion.div
            ...
            transition={{ duration: 0.2, ease: "linear" }}>
            {projectsLocalData.map(
              (project: LocalProjectItem, index: number) => {
